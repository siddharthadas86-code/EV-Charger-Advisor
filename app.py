...
# ==================== QUICK TOGGLES FIXED AT THE TOP ====================
...
with col5:
    if st.button("🛡️ Extended Warranty", use_container_width=True):
        st.session_state.messages.append({"role": "assistant", "content": "See full Extended Warranty prices in the left sidebar (0-90, 91-365, >365 days)."})
        st.rerun()
